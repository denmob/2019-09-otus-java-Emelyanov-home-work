...
class TestExecutor {
  ...
  TestExecutor(String testClassName) throws ClassNotFoundException {
  ...
  TestResult runTest() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
