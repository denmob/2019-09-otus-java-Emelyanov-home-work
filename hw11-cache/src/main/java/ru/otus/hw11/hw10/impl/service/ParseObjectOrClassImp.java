...
import ru.otus.hw11.hw10.api.service.ParseObjectOrClass;
import ru.otus.hw11.hw10.api.service.ParseObjectOrClassException;
...
public class ParseObjectOrClassImp implements ParseObjectOrClass {
  ...
  ParseObjectOrClassImp(Object object) {
  ...
  ParseObjectOrClassImp(Class<?> clazz) {
